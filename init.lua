...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      require('lspconfig').lua_ls.setup({
        cmd = { "lua-language-server" }, -- Executable name (should be in PATH)
        settings = {
          Lua = {
            runtime = {
              version = 'LuaJIT',
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'gdscript', 'zig' },
